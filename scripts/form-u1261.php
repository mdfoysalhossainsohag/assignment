...
function emailFormSubmission()
{
	...
	$to = '';
	$subject = 'Discussion Form Submission';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Name:</b></td><td>' . htmlentities($_REQUEST["custom_U1268"],ENT_COMPAT,'UTF-8') . '</td></tr>';
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Comment:</b></td><td>' . htmlentities($_REQUEST["custom_U1262"],ENT_COMPAT,'UTF-8') . '</td></tr>';
